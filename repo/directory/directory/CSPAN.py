...
api_key = "0j2wWr10819hVgK4DT8LSataj82U84 y9vafA4YX"
api_url = f"https://api.c-spanarchives.org/2.0/mentions?query=speaker&limit=&personid=&date={val}&maxdate=&mindate=&page=&videotype=?apikey={api_key}"
